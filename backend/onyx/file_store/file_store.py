...
def get_default_file_store() -> FileStore:
    ...
    Supports GCP Cloud Storage, AWS S3, MinIO, and other S3-compatible storage.
    ...
    """
    if FILE_STORE_TYPE == "gcp":
        from onyx.file_store.gcp_file_store import get_gcp_file_store
        return get_gcp_file_store()
    elif FILE_STORE_TYPE == "local":
        return get_local_file_store()
    else:
